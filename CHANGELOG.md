...
| Version | Description |
|---------|-------------|
| 4.0.51 | [PR#4180](https://github.com/bbc/psammead/pull/4180) Use custom PAT instead of default for Talos PR's
...
| 4.0.13 | [PR#4028](https://github.com/bbc/psammead/pull/4028) Talos - Bump Dependencies - @bbc/psammead-bulletin, @bbc/psammead-embed-error, @bbc/psammead-episode-list, @bbc/psammead-image-placeholder, @bbc/psammead-media-indicator, @bbc/psammead-media-player, @bbc/psammead-navigation, @bbc/psammead-play-button, @bbc/psammead-radio-schedule |
| 4.0.12 | [PR#4029](https://github.com/bbc/psammead/pull/4029) Talos - Bump Dependencies - @bbc/psammead-styles |
| 4.0.11 | [PR#4010](https://github.com/bbc/psammead/pull/4010) Talos - Bump Dependencies - @bbc/psammead-assets |
...
| 3.0.11 | [PR#3855](https://github.com/bbc/psammead/pull/3855) Talos - Bump Dependencies - @bbc/gel-foundations |
...
| 2.2.5 | [PR#3664](https://github.com/bbc/psammead/pull/3664) Bumping dependencies |
...
| 2.0.183 | [PR#3613](https://github.com/bbc/psammead/pull/3613) Talos - Bump Dependencies - @bbc/psammead-assets |
...
| 2.0.148 | [PR#3465](https://github.com/bbc/psammead/pull/3465) Talos - Bump Dependencies - @bbc/psammead-radio-schedule |
...
| 2.0.96 | [PR#3226](https://github.com/bbc/psammead/pull/3226) Talos - Bump Dependencies - @bbc/psammead-most-read, @bbc/psammead-sitewide-links |
...
| 2.0.82 | [PR#3079](https://github.com/bbc/psammead/pull/3079) Format duration time for the ProgramCard in RadioSchedule Package |
...
| 1.7.14 | [PR#2111](https://github.com/bbc/psammead/pull/2111) Talos - Bump Dependencies - @bbc/psammead-locales |
| 1.7.14 | [PR#2145](https://github.com/bbc/psammead/pull/2145) Talos - Bump Dependencies - @bbc/psammead-styles |
| 1.7.13 | [PR#2080](https://github.com/bbc/psammead/pull/2080) Add 'eslint-plugin-es5' for use in @bbc/psammead-locales |
| 1.7.13 | [PR#2090](https://github.com/bbc/psammead/pull/2090) Talos - Bump Dependencies - @bbc/psammead-locales |
...
| 1.7.11 | [PR#2089](https://github.com/bbc/psammead/pull/2089) Upgrade to Node 10.16.3 |
...
| 1.7.10 | [PR#2084](https://github.com/bbc/psammead/pull/2084) Talos - Bump Dependencies - @bbc/psammead-story-promo |
